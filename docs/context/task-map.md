...
- [core.md](./core.md)
- [current-state.md](../session/current-state.md)
- [review-workflow.md](../tasks/review-workflow.md)
- [testing.md](../knowledge/testing.md)
...
- [core.md](./core.md)
- [current-state.md](../session/current-state.md)
- [security-workflow.md](../tasks/security-workflow.md)
- [commands.md](../knowledge/commands.md)
- [prompt de seguranca](../../prompts/security_review.md)

## Trabalhar com ESP32, serial ou sensores
...
## Fazer release, deploy ou rollback

Carregar:

- [release-workflow.md](../tasks/release-workflow.md)
